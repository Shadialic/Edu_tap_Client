          ...
          <div className="flex-col gap-5 w-[75%] h-auto mt-5">
            ...
            <div className="flex justify-end items-end mr-10">
              <button
                ...
                className="w-[15%] h-10 bg-violet-600 text-white shadow-lg rounded-md font-prompt"
              >
                Your Enrollments
              </button>
            </div>
                  ...
                  >
                    <div className="flex w-full h-full bg-gray-100  justify-center items-center ">
                      <div className="flex flex-col justify-center items-center w-[90%] h-[80%] bg-white rounded-md shadow-md">
                        <p className="ml-2 text-base font-prompt-semibold font-prompt  mb-3 mt-2 pt-2">
                          {item.title}
                        </p>
            ...
            <div className="flex mb-6">
              {filteredCourses && filteredCourses.length > 0 ? (
                filteredCourses.map((item) => (
                  ...
                  >
                    <div className="flex flex-col w-[90%] mx-auto">
                      <div className="flex w-full h-[55%] p-4 bg-white shadow-lg justify-center items-center">
                        <img
                ...
                <div className="flex w-full">
                  <h1 className="font-prompt text-xl  text-center p-20 ml-72 ">
                    Not Found
                  </h1>
                </div>
              )}
