            ...
            <li>
              <a className="active" href="#/dashboard/home" aria-current="page">
                <Link to='/admin/dashboard'
                  className="align-middle select-none font-sans font-bold text-center transition-all disabled:opacity-50 disabled:shadow-none disabled:pointer-events-none text-xs py-3 rounded-lg  text-gray-800 shadow-md  hover:shadow-lg hover:shadow-gray-900/20 w-full flex items-center gap-4 px-4 capitalize"
                  type="button"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
